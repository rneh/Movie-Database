...
CREATE TABLE movie (
	...
	dateReleased DATE,
	prodCompId int(11) NOT NULL,
	FOREIGN KEY (prodComp) REFERENCES productionCompany(id),
	PRIMARY KEY (id)
...
--Creates a table called productionCompany:
--ID: primary key, auto-increment
--name: name of production company
--dateFounded: date the production company was founded
